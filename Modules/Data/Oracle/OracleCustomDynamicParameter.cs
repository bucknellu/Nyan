...
{
    public class OracleCustomDynamicParameters : SqlMapper.IDynamicParameters
    {
        ...
        /// </summary>
        public OracleCustomDynamicParameters() { }

        /// <summary>
        ///     construct a dynamic parameter bag
        /// </summary>
        /// <param name="template">can be an anonymous type or a DynamicParameters bag</param>
        public OracleCustomDynamicParameters(object template) { AddDynamicParams(template); }

        /// <summary>
        ///     All the names of the param in the bag, use Get to yank them out
        /// </summary>
        public IEnumerable<string> ParameterNames { get { return parameters.Select(p => p.Key); } }
            ...
            )
        {
            ...
            if (obj != null)
            {
                var subDynamic = obj as OracleCustomDynamicParameters;
                if (subDynamic == null)
                {
