...
// Source: https://github.com/WebApiContrib/WebApiContrib.Formatting.Jsonp/tree/master/src/WebApiContrib.Formatting.Jsonp
namespace Nyan.Modules.Web.REST.formatters.jsonp
{
    ...
    public class JsonpMediaTypeFormatter : MediaTypeFormatter
    {
            ...
            : this(jsonMediaTypeFormatter, callbackQueryParameter)
        {
            ...
            {
                throw new InvalidOperationException("Invalid callback parameter");
            }
        ...
        public override MediaTypeFormatter GetPerRequestFormatterInstance(Type type, HttpRequestMessage request, MediaTypeHeaderValue mediaType)
        {
            ...
            throw new InvalidOperationException("A callback parameter was not provided in the request URI.");
        }
